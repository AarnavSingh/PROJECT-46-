...
maze.add(createSprite(254,502,8,45));
  ...
  powerpallet.add(createSprite(64,122,20,20));
  powerpallet.add(createSprite(428,100,20,20));
  powerpallet.add(createSprite(60,522,20,20));
  powerpallet.add(createSprite(423,523,20,20));
  ...
  for(var i=50;i<=445;i+=25){
    for(var j=33;j<=565;j+=20){
      ...
      if(coin.overlap(centre)||coin.overlap(centre1)||coin.overlap(centre2)||coin.overlap(centre3)||coin.overlap(centre4)|| coin.overlap(maze)){
      coin.visible=false;
    }
